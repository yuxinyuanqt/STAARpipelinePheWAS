#' Gene-centric PheWAS analysis of long noncoding RNA (ncRNA) category using STAAR procedure
#'
#' The \code{ncRNA_PheWAS} function takes in chromosome, gene name,
...
#' quantitative/dichotomous phenotypes (including imbalanced case-control design) and the exonic and splicing category of an ncRNA gene by using STAAR procedure.
...
#' @return A list of data frames containing the STAAR p-values (including STAAR-O or STAAR-B in imbalanced case-control setting) corresponding to the exonic and splicing category of the given ncRNA gene for each phenotype.
...
ncRNA_PheWAS <- function(chr,gene_name,genofile,obj_nullmodel_list,
